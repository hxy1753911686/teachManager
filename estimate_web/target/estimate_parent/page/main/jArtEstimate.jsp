								    ...
								    <div class="am-tab-panel am-fade am-in am-active" id="tab1">
								     ...
								     <table class="am-table am-table-bordered am-table-centered am-table-striped am-table-hover">
									  ...
									  <tr>
									    ...
									    <td >课堂出勤</td>
									    <td class=""><input type="number" max="1" min="0" name="artAttendanceValue" value="${artAttendanceValue }" 
									     	<c:if test="${artAttendanceDisabled eq 'yes' }">disabled="disabled"</c:if> 
									      >/1</td>
									  </tr>
									  <tr>
									    <td >课堂表现</td>
									    <td ><input type="number" max="3" min="0" name="artPerformanceValue" value="${ artPerformanceValue}" 
									    	<c:if test="${artPerformanceDisabled eq 'yes' }">disabled="disabled"</c:if>
									    >/3</td>
									  </tr>
									  <tr>
									    <td>绘画作品</td>
									    <td><input type="number" max="2" min="0" name="paintingValue" value="${paintingValue }" 
									    	<c:if test="${paintingDisabled eq 'yes' }">disabled="disabled"</c:if>
									    >/2</td>
									  </tr>
									  <tr>
									    <td >手工作品</td>
									    <td><input type="number" max="2" min="0" name="manualValue" value="${manualValue }" 
									    	<c:if test="${manualDisabled eq 'yes' }">disabled="disabled"</c:if>
									    >/2</td>
									  </tr>
