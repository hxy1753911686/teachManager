						...
						<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
							<div class="widget am-cf">
								<div class="widget-head am-cf">
									<div class="widget-title am-fl">编辑[${name }]信息</div>
								...
								<div class="widget-body am-fr">
									...
									<form class="am-form tpl-form-border-form tpl-form-border-br" id="classesForm" action="classesAction_update" >
										<input type="hidden" name="id" value="${id }" >
										<div class="am-form-group am-u-md-12">
											<label for="user-name" class="am-u-sm-3 am-form-label">班级名称</label>
											<div class="am-u-sm-9">
												<input type="text" class="tpl-form-input" placeholder="请输入班级名称" name="name" value="${name }">
											</div>
										</div>
												...
												<select data-am-selected name="banId" >
												  ...
												  <c:forEach items="${banList }" var="ban">
													  <option value="${ban.id }" 
													    ...
													    <c:if test="${banId != null && fn:contains(ban.id,banId)}">
											       			selected
											   			</c:if> 
											   			>${ban.name }</option>
												  </c:forEach>
										...
										<div class="am-form-group am-u-md-12">
											...
											<div class="am-u-sm-9">
												<input type="text" class="tpl-form-input" placeholder="请选择班级的开班日期" data-am-datepicker="" readonly name="startTime" value="<fmt:formatDate value="${startTime}" pattern="yyyy-MM-dd"/>">
											</div>
										</div>
										...
										<div class="am-form-group am-u-md-12">
											...
											<div class="am-u-sm-9">
												<label class="am-radio am-secondary">
												  <input type="radio" name="isUse" value="1" data-am-ucheck <c:if test="${isUse == 1}">checked="checked"</c:if>> 启用
												</label>
												<label class="am-radio am-secondary">
												  <input type="radio" name="isUse" value="0" data-am-ucheck <c:if test="${isUse == 0}">checked="checked"</c:if>> 停用
												</label>
											</div>
										</div>
