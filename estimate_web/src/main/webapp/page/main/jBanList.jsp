	...
	<div class="am-g tpl-g">
		...
		<div class="left-sidebar">
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-nav-link">
                    <li class="sidebar-nav-link"><a href="${pageContext.request.contextPath }/main/estimateAction_toClassStudent" class="active" > <i
											...
											<tr class="gradeX">
												...
												<td>
													<div class="tpl-table-black-operation">
														<a href="estimateAction_toBanEstimate?studentId=${student.id}&term=${term}" > <i class="am-icon-laptop"></i>
															评价
														</a> 
														<a href="estimateAction_toStudentView?studentId=${student.id}&term=${term}" 
															class="tpl-table-black-operation-del"> <i
															class="am-icon-eye"></i> 查看评分
														</a>
