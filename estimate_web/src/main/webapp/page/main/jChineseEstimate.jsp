							...
							<div class="widget am-cf">
								...
								<div class="am-tabs" data-am-tabs>
								  ...
								  <div class="am-tabs-bd">
								    ...
								    <form method="post" id="chineseFrom" action="estimateAction_saveChinese">
								    <input type="hidden" name="subjectId" value="${subjectId }"  >
								     <input type="hidden" name="classId" value="${classId }" >
								     <input type="hidden" name="studentId" value="${id }" >
								     <input type="hidden" name="term" value="${term }" >
									  ...
									  <tr>
									    <td rowspan="2" class="am-text-middle" id="reading" >阅读能力<span class="am-badge am-badge-warning am-round">note</span></td>
									    <td >完成规定的课外阅读书目</td>
									    <td ><input type="number" max="2" min="0" name="outsideReadingValue" value="${ outsideReadingValue}" 
									    	<c:if test="${outsideReadingDisabled eq 'yes' }">disabled="disabled"</c:if>
									    >/2</td>
									  </tr>
									  <tr>
									    <td>独到的见解和感受（发表）</td>
									    <td ><input type="number" max="2" min="0" name="opinionValue" value="${ opinionValue}" 
									    	<c:if test="${opinionDisabled eq 'yes' }">disabled="disabled"</c:if>
									    >/2</td>
									  </tr>
								     </table>
								    <div class="am-form-group am-u-md-12" style="text-align: center;">
											<button type="button" class="am-btn am-btn-default am-btn-secondary" onclick="formSubmit1()" ><span class="am-icon-save"></span> 保存</button>
										</div>
								     </form>
								     ...
								     <script type="text/javascript">
										...
										function formSubmit1(){
											document.getElementById("chineseFrom").submit();
										}
									</script>
								    </div>
