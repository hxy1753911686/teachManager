						...
						<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
							<div class="widget am-cf">
								<div class="widget-head am-cf">
									<div class="widget-title am-fl">新增教师</div>
								...
								<div class="widget-body am-fr">
									...
									<form class="am-form tpl-form-border-form tpl-form-border-br" id="teacherForm" action="teacherAction_create">
										<div class="am-form-group am-u-md-6">
											<label for="user-name" class="am-u-sm-3 am-form-label">姓名</label>
											<div class="am-u-sm-9">
												<input type="text" class="tpl-form-input" placeholder="请输入教师姓名" name="name">
											</div>
										</div>
										...
										<div class="am-form-group am-u-md-6">
											...
											<div class="am-u-sm-9">
												<input type="text" class="tpl-form-input" placeholder="请输入联系方式" name="tel">
											</div>
										</div>
