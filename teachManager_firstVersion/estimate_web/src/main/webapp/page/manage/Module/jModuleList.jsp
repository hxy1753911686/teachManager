	...
	<div class="am-g tpl-g">
		...
		<div class="left-sidebar">
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-nav-link"><a href="moduleAction_toList" class="active"> <i
					...
					<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
						<div class="widget am-cf">
							<div class="widget-head am-cf">
								<div class="widget-title  am-cf">模块列表</div>
									...
									<div class="am-form-group">
										<div class="am-btn-toolbar">
											<div class="am-btn-group am-btn-group-xs">
												...
												<script type="text/javascript">
													function toCreate(){
														location.href = "moduleAction_toCreate";
													}
												</script>
											</div>
										</div>
										...
										<c:forEach items="${moduleList}" var="module" varStatus="status">
											<tr class="gradeX">
												...
												<td>
													...
													<c:if test="${module.state == 0}">禁用</c:if>
												</td>
												
												<%-- <td>
													<div class="tpl-table-black-operation">
														<a href="moduleAction_toUpdate?id=${module.id}" > <i class="am-icon-pencil"></i>
															编辑
														</a> <a href="moduleAction_delete?id=${module.id}" 
