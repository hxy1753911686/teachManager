							...
							<div class="widget am-cf">
								...
								<div class="am-tabs" data-am-tabs>
								  <ul class="am-tabs-nav am-nav am-nav-tabs">
								    <li class="am-active"><a href="#tab1">艺术素养</a></li>
								  </ul>
								    ...
								    <div class="am-tab-panel am-fade am-in am-active" id="tab1">
								     ...
								     <table class="am-table am-table-bordered am-table-centered am-table-striped am-table-hover">
									  ...
									  <tr>
									    ...
									    <td >课堂出勤</td>
									    <td class=""><input type="number" max="1" min="0" name="musicAttendanceValue" value="${musicAttendanceValue }" 
									     	<c:if test="${musicAttendanceDisabled eq 'yes' }">disabled="disabled"</c:if> 
									      >/1</td>
									  </tr>
									  <tr>
									    <td >课堂表现</td>
									    <td ><input type="number" max="3" min="0" name="musicPerformanceValue" value="${ musicPerformanceValue}" 
									    	<c:if test="${musicPerformanceDisabled eq 'yes' }">disabled="disabled"</c:if>
									    >/3</td>
									  </tr>
									  <tr>
									    <td>歌曲乐器</td>
									    <td><input type="number" max="2" min="0" name="instrumentsValue" value="${instrumentsValue }" 
									    	<c:if test="${instrumentsDisabled eq 'yes' }">disabled="disabled"</c:if>
									    >/2</td>
									  </tr>
									  <tr>
									    <td >识谱</td>
									    <td><input type="number" max="2" min="0" name="musicScoreValue" value="${musicScoreValue }" 
									    	<c:if test="${musicScoreDisabled eq 'yes' }">disabled="disabled"</c:if>
									    >/2</td>
									  </tr>
