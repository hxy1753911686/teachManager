						...
						<div class="am-u-sm-12 am-u-md-6 am-u-lg-6"  >
							<div class="widget am-cf">
								<div class="widget-head am-cf">
									<div class="widget-title am-fl">查看[${name }]详情</div>
									<div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
								...
								<div class="am-panel-group" id="accordion">
									<div class="am-panel am-panel-default">
	    								<div class="am-panel-hd">
											<h4 class="am-panel-title " data-am-collapse="{parent: '#accordion', target: '#teachers'}">
        										教师列表
      										</h4>
										</div>
										<div id="teachers" class="am-panel-collapse am-collapse am-in">
										...
										<div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
											<div class="am-form-group">
												<div class="am-btn-toolbar">
													<div class="am-btn-group am-btn-group-xs">
														<button type="button" "
															class="am-btn am-btn-default am-btn-success">
															<span class="am-icon-retweet"></span><a href="classesAction_toTeacher?id=${id }"><font color="white">教师管理</font></a> 
														</button>
													</div>
												</div>
											</div>
									      ...
									      <div class="am-panel-bd">
												...
												<table width="100%"
													...
													<tbody>
													<c:forEach items="${teacherSet}" var="teacher" varStatus="status">
														<tr class="gradeX">
									    ...
									    <div class="am-panel-hd">
											<h4 class="am-panel-title " data-am-collapse="{parent: '#accordion', target: '#students'}">
        										学生列表
      										</h4>
										</div>
										<div id="students" class="am-panel-collapse am-collapse">
										<div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
											<div class="am-form-group">
												<div class="am-btn-toolbar">
													<div class="am-btn-group am-btn-group-xs">
														<button type="button" onclick="toCreate()"
															class="am-btn am-btn-default am-btn-success">
															<span class="am-icon-plus"></span><a href="studentAction_toCreate?classesId=${id }"><font color="white">新增</font></a> 
														</button>
													</div>
												</div>
											</div>
									      ...
									      <div class="am-panel-bd">
												...
												<table width="100%"
													...
													<tbody>
													<c:forEach items="${studentSet}" var="student" varStatus="status">
														<tr class="gradeX">
															<td>${status.index+1}</td>
															<td>${student.name }</td>
															<td>${student.no }</td>
															...
															<td>
																<div class="tpl-table-black-operation">
																	<a href="studentAction_toView?id=${student.id}" 
																		> <i
																		class="am-icon-book"></i> 查看
																	</a>
																	<a href="studentAction_toUpdate?id=${student.id}&classesId=${id}" > <i class="am-icon-pencil"></i>
																		编辑
																	</a>
																	<a href="studentAction_delete?id=${student.id}&classesId=${id}" > <i class="am-icon-close"></i>
																		删除
																	</a>
